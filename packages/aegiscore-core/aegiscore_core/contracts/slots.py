...
The Aegiscore agent factories assemble their middleware stack by
...
``aegiscore.agents.middleware_slots``. The langchain/deepagents-bound
...
register their own role here via the ``aegiscore.agents`` entry-point
