...
from aegiscore.telemetry.config import TelemetryConfig, TelemetryMode, resolve_config
from aegiscore.telemetry.exporter import BatchExporter, Transport
from aegiscore.telemetry.redact import Redactor
from aegiscore.telemetry.sanitizer import SCHEMA_VERSION, event_to_tier_a, scan_tier_c

log = logging.getLogger("aegiscore.telemetry.sink")
...
class TelemetrySink:
    ...
    def preview(self, sample_events: list[dict[str, Any]]) -> dict[str, Any]:
        ...
        Powers ``aegiscore telemetry preview`` — transparency before any send.
        """
        mapped = [
            ev
