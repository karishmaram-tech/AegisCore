"""FastMCP server exposing Aegiscore engagement control to external agents.
...
from aegiscore.mcp_server.auth import build_auth
from aegiscore.mcp_server.config import ServerConfig, load_config
from aegiscore.mcp_server.engagements import EngagementClient
from aegiscore.mcp_server.tools_interactive import register_interactive_tools
from aegiscore.mcp_server.tools_lifecycle import register_lifecycle_tools
...
def build_server(
    ...
    *,
    ...
    """Construct the Aegiscore engagement MCP server with all tools registered.
    ...
    mcp = FastMCP("aegiscore", host=host, port=port, token_verifier=verifier, auth=auth)
