...
These tools make the MCP surface feel like the Aegiscore CLI from a phone:
...
from aegiscore.mcp_server.conversation import build_engagement_state, build_transcript
