...
from aegiscore.mcp_server.models import FindingsResult
...
if TYPE_CHECKING:
    from aegiscore_core.types.kg import KnowledgeGraph
...
def load_findings_graph(engagement_name: str) -> KnowledgeGraph | None:
    ...
    # through the compat re-export; same call is used in aegiscore.cli.scan.
...
def summarize_findings(
    ...
    *,
    ...
    from aegiscore.tools.research.sarif_export import export_findings_to_sarif
