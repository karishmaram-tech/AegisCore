...
This package provides:
  ...
  - ``BlueCellAgent`` (in ``agents/standard/blue_cell.py``): a
    read-only Aegiscore agent that subscribes to the tap, evaluates
...
from aegiscore.blue_cell.rule_match import (
    DetectionEvent,
    DetectionRule,
    RuleMatcher,
    load_rules,
...
from aegiscore.blue_cell.tap import BlueCellTap, TapEvent
