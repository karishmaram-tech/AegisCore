...
- :mod:`aegiscore.agents.prompts.builder` — the prompt-assembly engine:
  fragment readers, :class:`PromptBuilder`, :func:`load_prompt`, the
  cross-cutting pattern constants, and the cache-boundary constant.
- :mod:`aegiscore.agents.prompts.registry` — language / locale data and
...
``from aegiscore.agents.prompts import X`` keeps working unchanged. The
...
See :mod:`aegiscore.agents.prompts.builder` for the assembly design notes
...
from aegiscore.agents.prompts.builder import (
...
from aegiscore.agents.prompts.registry import (
