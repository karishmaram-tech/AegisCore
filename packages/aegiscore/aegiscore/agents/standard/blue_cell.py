...
applies any plugin overrides discovered via the ``aegiscore.bundles``
entry-point group.
...
from aegiscore.tools.defense.blue_cell import blue_cell_scan
from aegiscore.tools.defense.brief import defense_brief, export_attack_navigator
from aegiscore.tools.research.tools import kg_neighbors, kg_query, kg_stats
    ...
    *,
    ...
    Args:
        ...
        tools: full tool list — when provided, replaces the standard registry
            ...
            plugin overrides (via ``aegiscore.bundles``) are applied.
