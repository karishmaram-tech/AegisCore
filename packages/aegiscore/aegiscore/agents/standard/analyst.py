...
The Analyst is Aegiscore's high-value discovery lane: source code review,
...
``aegiscore.tools.research._state`` shim; that retirement is PR-D
...
from aegiscore.tools.web.search import web_fetch, web_search
...
_STANDARD_TOOLS: dict[str, Any] = {
    ...
    # ``aegiscore.tools.research._state`` shim until PR-D extracts the
