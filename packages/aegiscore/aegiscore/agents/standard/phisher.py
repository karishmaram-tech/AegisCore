...
Skills tree (under packages/aegiscore/aegiscore/skills/standard/phisher/):
...
from aegiscore.tools.references.tools import (
    killchain_lookup,
    methodology_lookup,
    payload_search,
)
...
def create_phisher_agent(
    *,
    ...
    ``packages/aegiscore/aegiscore/agents/standard/ad_operator.py`` for
