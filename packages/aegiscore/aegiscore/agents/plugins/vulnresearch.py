...
Mirrors :mod:`aegiscore.agents.aegiscore` (the red-team orchestrator)
...
def create_vulnresearch_agent(
    *,
    ...
    # under the ``aegiscore.subagents`` entry-point group; this main
    ...
    # ``aegiscore/plugin_loader.py`` for the loader contract.
