...
from aegiscore.tools.defense.blue_cell import node_techniques
from aegiscore.tools.research._state import _json, _load
from aegiscore_core.types.kg import EdgeKind, KnowledgeGraph, NodeKind
...
def build_navigator_layer(brief: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        "name": f"Aegiscore Detection Coverage — {brief['engagement']}",
        "versions": {"layer": "4.5", "navigator": "4.9.5", "attack": "15"},
        "domain": "enterprise-attack",
        "description": (
            "Proven detection coverage from the Aegiscore Offensive Vaccine loop. "
