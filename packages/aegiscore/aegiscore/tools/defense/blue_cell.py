...
:class:`~aegiscore.blue_cell.tap.BlueCellTap` +
:class:`~aegiscore.blue_cell.rule_match.RuleMatcher`, and records every rule
...
from aegiscore.blue_cell.rule_match import RuleMatcher, load_rules
from aegiscore.blue_cell.tap import BlueCellTap
from aegiscore.tools.research._state import _json, graph_transaction
from aegiscore_core.types.kg import Edge, EdgeKind, KnowledgeGraph, Node, NodeKind
