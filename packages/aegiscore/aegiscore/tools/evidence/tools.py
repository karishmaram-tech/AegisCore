...
from aegiscore.middleware._audit_sink import (
    _GENESIS_PREV_HASH,
    _record_hash,
    _record_hmac,
)
from aegiscore.tools.evidence.asciicast import (
...
def export_session_asciicast(
    ...
    Args:
        ...
        title: optional asciicast title; defaults to ``"Aegiscore session <name>"``.
    """
    log_path = (
