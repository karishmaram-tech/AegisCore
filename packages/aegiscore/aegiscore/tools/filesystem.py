"""Filesystem tool-surface helpers for Aegiscore middleware."""
...
def filesystem_tools_without_execute(tools: Sequence[Any]) -> list[Any]:
    ...
    Aegiscore routes command execution through its dedicated bash tools, while
    Deep Agents' filesystem middleware owns file operations. Keeping this
    selection helper in ``aegiscore.tools`` makes the public tool surface
