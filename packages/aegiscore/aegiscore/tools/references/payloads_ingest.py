...
The folder name is normalised into the Aegiscore ``vuln_class`` slug
...
from aegiscore.tools.references.payloads import BUNDLED_PAYLOADS, PayloadBundle

REPO_SLUG = "payloads-all-the-things"

# Canonical Aegiscore vuln_class labels used by the rest of the
...
def classify_dir(dir_name: str) -> str | None:
    """Map an upstream folder name to a Aegiscore vuln_class slug.
