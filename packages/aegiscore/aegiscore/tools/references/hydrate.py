...
``aegiscore/references/`` knows how to parse. Safe to call multiple
times — ``ensure_cached`` does a fast-forward pull when the clone is
already present.

Usage::

    from aegiscore.tools.references.hydrate import hydrate_all
    hydrate_all()

or as a one-liner::

    python -m aegiscore.references.hydrate
...
from aegiscore.tools.references.cve_poc_index import (
    MRXN_SLUG,
    TRICKEST_SLUG,
    build_index,
    invalidate_cache,
...
from aegiscore.tools.references.fetch import ReferenceCache, ensure_cached
from aegiscore.tools.references.h1_corpus import invalidate_corpus_cache
from aegiscore.tools.references.killchain import invalidate_entries_cache
from aegiscore.tools.references.methodology import invalidate_chapters_cache
from aegiscore.tools.references.oneliners import invalidate_recipes_cache
from aegiscore.tools.references.payloads_ingest import invalidate_merged_cache
