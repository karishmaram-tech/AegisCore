"""Bash tool for the Aegiscore agent.

Thin wrapper around HTTPSandbox.execute_tmux(). All tmux session
management and PS1 polling logic lives in aegiscore/sandbox_kernel/
...
from aegiscore.sandbox_kernel.base import SandboxBase
from aegiscore.sandbox_kernel.tmux import _interpret_exit_code

log = logging.getLogger("aegiscore.tools.bash.bash")
...
def _sandbox_from_config(config: RunnableConfig | None) -> HTTPSandbox | None:
    ...
    from aegiscore.backends.factory import _shared_sandbox
