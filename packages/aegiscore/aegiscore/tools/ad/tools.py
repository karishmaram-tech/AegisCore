...
``bhce_*`` surface in :mod:`aegiscore.tools.ad.bh_tools`.  They emit
``DeprecationWarning`` on every invocation, remain functional for
one minor cycle, then move to ``aegiscore.compat``, then are
...
from aegiscore.tools.ad.adcs import analyze_adcs_templates
from aegiscore.tools.ad.adcs_post import synthesise_adcs_post as _synthesise_adcs_post
from aegiscore.tools.ad.bh_tools import BHCE_TOOLS
from aegiscore.tools.ad.bloodhound import (
...
from aegiscore.tools.ad.delegation import analyze_delegation
from aegiscore.tools.ad.gpo import analyze_gpo_abuse
from aegiscore.tools.ad.kerberos import classify_hashcat_hash, parse_ticket
from aegiscore.tools.ad.shadow_creds import analyze_shadow_credentials
from aegiscore.tools.research._engagement_scope import _LEGACY_ENGAGEMENT_LABEL
from aegiscore.tools.research._state import _load, _save
