...
stage-3 :func:`~aegiscore.research.tools.validate_finding` used) inside
the same sandbox via :func:`aegiscore.research.poc.sandbox_runner`. If
...
from aegiscore.tools.research._state import _json, _load, _save
from aegiscore.tools.research.poc import sandbox_runner
from aegiscore_core.types.kg import Edge, EdgeKind, Node, NodeKind, Severity
