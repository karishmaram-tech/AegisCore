...
from aegiscore.tools.contracts.patterns import scan_solidity_source
from aegiscore.tools.contracts.slither import ingest_slither_file
from aegiscore.tools.research import cve as cve_mod
from aegiscore.tools.research import fuzz as fuzz_mod
from aegiscore.tools.research.chain import critical_path_score, plan_chains, promote_chain
from aegiscore.tools.research.dedupe import kg_dedupe_findings
from aegiscore.tools.research.health import backend_health
from aegiscore.tools.research.osint import OSINT_TOOLS
from aegiscore.tools.research.patch import PATCH_TOOLS
from aegiscore.tools.research.sarif import ingest_sarif_file
from aegiscore.tools.research.scanner_tools import SCANNER_TOOLS
from aegiscore.tools.research.secret_scanner import scan_secrets
from aegiscore.tools.research.tech_detection import detect_tech_stack
from aegiscore.tools.reversing.binary import identify_binary
from aegiscore.tools.reversing.packer import detect_packer
from aegiscore.tools.reversing.strings import extract_strings, group_by_category
from aegiscore.tools.reversing.symbols import summarize_symbols
from aegiscore.tools.web.jwt import parse_token
from aegiscore.tools.web.oauth import analyze_oauth_callback
from aegiscore.tools.web.session import analyze_cookie
from aegiscore_core.types.kg import (
    SEVERITY_SCORE,
    Edge,
    EdgeKind,
    KnowledgeGraph,
...
from aegiscore_core.utils.logging import get_logger
...
from aegiscore.tools.research._state import (  # noqa: E402
    _json,
    _kg_backend_name,
    graph_transaction,
    kg_degrades,
...
def kg_ingest_slither(path: str) -> str:
    ...
    RESEARCH_TOOLS).
    """
    from aegiscore.tools.research._engagement_scope import _LEGACY_ENGAGEMENT_LABEL
    from aegiscore_core.utils.engagement_scope import get_active_engagement
...
async def validate_finding(
    ...
    """
    from aegiscore.tools.bash.bash import get_sandbox
    from aegiscore.tools.research.poc import (
        AC,
        AV,
        PR,
        UI,
