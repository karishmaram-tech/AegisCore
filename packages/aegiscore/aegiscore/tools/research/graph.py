"""Compat shim — content moved to ``aegiscore_core.types.kg``.
...
import aegiscore_core.types.kg as _target

_LEGACY = "aegiscore.tools.research.graph"
_CANONICAL = "aegiscore_core.types.kg"
_seen: set[str] = set()
