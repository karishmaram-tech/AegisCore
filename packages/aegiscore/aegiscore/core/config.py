"""Compat shim — content moved to ``aegiscore_core.utils.config``.
...
import aegiscore_core.utils.config as _target

_LEGACY = "aegiscore.core.config"
_CANONICAL = "aegiscore_core.utils.config"
_seen: set[str] = set()
