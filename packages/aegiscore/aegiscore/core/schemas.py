"""Compat shim — content moved to ``aegiscore_core.types.engagement``.
...
import aegiscore_core.types.engagement as _target

_LEGACY = "aegiscore.core.schemas"
_CANONICAL = "aegiscore_core.types.engagement"
_seen: set[str] = set()
