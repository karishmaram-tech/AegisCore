"""Compat shim — content moved to ``aegiscore_core.utils.logging``.
...
import aegiscore_core.utils.logging as _target

_LEGACY = "aegiscore.core.logging"
_CANONICAL = "aegiscore_core.utils.logging"
_seen: set[str] = set()
