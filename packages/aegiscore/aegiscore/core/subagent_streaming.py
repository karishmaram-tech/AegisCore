...
When the Aegiscore orchestrator delegates to a sub-agent via task(),
...
log = logging.getLogger("aegiscore.subagent_streaming")
...
def _bind_per_run_sandbox():
    ...
    try:
        ...
        if sandbox_url:
            ...
            from aegiscore.tools.bash.bash import _sandbox_var, set_sandbox
