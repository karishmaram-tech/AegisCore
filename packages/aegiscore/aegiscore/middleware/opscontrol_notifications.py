...
Mirror of :mod:`aegiscore.middleware.notifications` (which handles bash
...
→ background-completion notification, Aegiscore's own
...
from aegiscore.tools.ops.client import (
    OpsControlClient,
    OpsControlError,
