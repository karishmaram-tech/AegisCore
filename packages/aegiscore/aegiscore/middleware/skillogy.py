...
def _backend_factory():
    ...
    duck-typed contract.
    """
    from aegiscore.skillogy.client.rest import RestSkillogyClient  # noqa: PLC0415
...
def maybe_install_skillogy(
    ...
    *,
    ...
    try:
        from aegiscore.middleware.skills import SkillsMiddleware  # noqa: PLC0415
    except ImportError:
        return middleware_stack
...
def _resolve_allowed_path_prefixes(
    *,
    ...
    if not role:
        return None
    try:
        from aegiscore.agents.middleware_slots import skills_sources_for  # noqa: PLC0415
    except ImportError:
        return None
    try:
