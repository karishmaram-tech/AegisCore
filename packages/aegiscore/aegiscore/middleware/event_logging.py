...
``aegiscore.runtime.event_log.EventLog`` is the append-only writer for an
...
Design mirrors :class:`aegiscore.runtime.recording.RecordingMiddleware`
...
(:mod:`aegiscore.tools.research.tools` / ``poc.py``), which materializes a
...
from aegiscore.runtime.event_log import EventLog, EventType
from aegiscore.telemetry.sink import get_sink, session_id_for
...
def _roe_literal_targets(workspace: str) -> list[str]:
    ...
    from aegiscore_core.types.roe import MachineEnforcement
