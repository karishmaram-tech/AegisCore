...
from aegiscore.middleware._audit_sink import RoEAuditSink
...
class RoEGuardrailMiddleware(AgentMiddleware):
    ...
    def _maybe_provision_egress(self, state) -> None:
        ...
        try:
            from aegiscore.backends.factory import build_sandbox_backend
            from aegiscore.middleware.egress import compile_egress_policy
