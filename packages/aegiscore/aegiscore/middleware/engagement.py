...
Pattern matches OPPLANMiddleware (aegiscore/middleware/opplan.py) —
...
from aegiscore.middleware.opplan import _reduce_engagement_name, _reduce_workspace_path
from aegiscore.middleware.state_reducers import reduce_converging_value
from aegiscore.tools.bash.bash import bash_workspace
