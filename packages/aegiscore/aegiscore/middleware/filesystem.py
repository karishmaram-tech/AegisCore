...
from aegiscore.tools.filesystem import filesystem_tools_without_execute
...
def _rebind_sandbox_per_run(backend: BackendProtocol, runtime: Any = None) -> BackendProtocol:
    ...
    from aegiscore.backends import build_sandbox_backend
...
class FilesystemMiddleware(BaseFilesystemMiddleware):
    """FilesystemMiddleware with Aegiscore's bash tool as the only executor."""
