...
``aegiscore.kg.ingesters`` entry-point group.
...
from aegiscore.middleware.kg_internal.ai_surface import (
...
_PLUGIN_GROUP = "aegiscore.kg.ingesters"


def load_plugin_adapters() -> int:
    """Discover and register adapters from the ``aegiscore.kg.ingesters``
    ...
    Plugin authors expose adapters as::
        ...
        # pyproject.toml
        [project.entry-points."aegiscore.kg.ingesters"]
