"""``aegiscore-cli export-transcript`` - render an engagement's event log.
...
:mod:`aegiscore.runtime.event_log`); events are rendered in the order they
were appended.
"""
...
from aegiscore.runtime.event_log import EngagementEvent, EventType, read_events
...
def _build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(
        prog="aegiscore-cli export-transcript",
