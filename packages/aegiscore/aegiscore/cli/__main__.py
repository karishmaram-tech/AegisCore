"""``python -m aegiscore.cli`` dispatcher."""

from __future__ import annotations

import sys

from aegiscore.cli.audit import main as audit_main
from aegiscore.cli.auth import main as auth_main
from aegiscore.cli.export_transcript import main as export_transcript_main
from aegiscore.cli.scan import main as scan_main
from aegiscore.cli.telemetry import main as telemetry_main
from aegiscore.cli.zip import main as zip_main


def _print_help() -> int:
    print(
        "aegiscore-cli — headless / CI entry\n\n"
        "Subcommands:\n"
