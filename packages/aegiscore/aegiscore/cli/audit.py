"""``aegiscore-cli audit`` - engagement audit ledger utilities."""
...
from aegiscore.middleware._audit_sink import VerifyResult, verify_ledger
...
def _build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(
        prog="aegiscore-cli audit",
        description="Verify Aegiscore engagement audit ledgers.",
    )
