...
def _pick_executor(capabilities: list[str], device_class: str) -> str:
    # Aegiscore: there is NO Playwright-MCP inside the sandbox (MCP is a
...
def run_playwright_fallback(
    ...
    *,
    ...
    # Aegiscore: no Playwright-MCP exists inside the sandbox. A profile's
    ...
    args: dict = {
        ...
        # Aegiscore: the sandbox has no X display. Default to headless so the
