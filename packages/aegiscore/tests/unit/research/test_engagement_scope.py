...
from aegiscore.tools.research import _engagement_scope as _scope
from aegiscore.tools.research._engagement_scope import (
...
# (``aegiscore.middleware.kg_internal.store``) enforces engagement
