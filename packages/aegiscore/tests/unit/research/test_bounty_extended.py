...
from aegiscore.tools.research import _state as state  # noqa: E402
from aegiscore.tools.research.bounty import bounty_scope_check, format_bounty_report  # noqa: E402
from aegiscore_core.types.kg import Edge, EdgeKind, KnowledgeGraph, Node, NodeKind  # noqa: E402
...
class TestFormatBountyReport:
    ...
    def _invoke_with_mocked_path(
        ...
        with _patch("aegiscore.tools.research.bounty.Path") as mock_path_cls:
