...
# ``aegiscore.tools.research.bounty`` transitively pulls in
# ``aegiscore.backends.http_sandbox`` which requires ``deepagents``.
...
from aegiscore.tools.research.bounty import (  # noqa: E402
    _COMMONLY_EXCLUDED,
    BOUNTY_TOOLS,
    _normalize_class,
    _severity_label,
)
from aegiscore_core.types.kg import (  # noqa: E402
    Edge,
    EdgeKind,
    KnowledgeGraph,
    Node,
...
class TestFindLinkedVuln:
    ...
    def test_finds_via_validates_edge(self) -> None:
        from aegiscore.tools.research.bounty import _find_linked_vuln
