...
The tools wrap :mod:`aegiscore.tools.ad.bhce_client`; here we stub the
...
from aegiscore.tools.ad.bh_tools import (
    bhce_cypher,
    bhce_ingest_zip,
    bhce_status,
)
...
def test_bhce_ingest_zip_runs_three_step_and_polls_until_terminal(
    ...
    monkeypatch.setattr("aegiscore.tools.ad.bh_tools._UPLOAD_POLL_INTERVAL_SECONDS", 0.01)
