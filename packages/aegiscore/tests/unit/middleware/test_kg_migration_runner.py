...
from aegiscore.middleware.kg_internal.migration_runner import (
...
from aegiscore.middleware.kg_internal.store import KGStore, KGStoreConfig
...
def test_shipped_migrations_present_and_parseable() -> None:
    ...
    from aegiscore.middleware.kg_internal.migration_runner import _DEFAULT_MIGRATIONS_DIR
