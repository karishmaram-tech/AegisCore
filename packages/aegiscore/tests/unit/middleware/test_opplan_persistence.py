...
from aegiscore.middleware import opplan as opplan_mod
from aegiscore.middleware.opplan import OPPLANMiddleware
from aegiscore.tools.opplan import (
...
from aegiscore_core.types.engagement import OPPLAN, Objective, ObjectivePhase
