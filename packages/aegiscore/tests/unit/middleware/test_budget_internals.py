"""Infra-free coverage for ``aegiscore.middleware.budget`` internals.
...
from aegiscore.middleware import budget as budget_mod
from aegiscore.middleware.budget import (
...
def _install_stub_config(monkeypatch: pytest.MonkeyPatch) -> None:
    import aegiscore_core.utils.config as core_config
