...
from aegiscore.agents.middleware_slots import _SafeSummarizationProxy

# The ``aegiscore`` parent logger is configured with ``propagate=False``
# (see aegiscore_core.utils.logging), so caplog's root-attached handler
...
_PROXY_LOGGER = "aegiscore.agents.middleware_slots"
