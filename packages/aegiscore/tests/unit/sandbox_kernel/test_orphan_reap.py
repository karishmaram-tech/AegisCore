...
reap path discovers pre-existing aegiscore-named sockets on the host and
...
from aegiscore.sandbox_kernel.base import _compute_orphan_tmux_sessions
...
def test_reap_swallows_kill_failures(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("aegiscore.sandbox_kernel.base._kill_tmux_socket", flaky_kill)
