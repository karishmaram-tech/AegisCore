...
from aegiscore.cli import auth
from aegiscore.cli.auth import main as auth_main
from aegiscore.llm import factory
from aegiscore.llm.factory import AuthInventory, AuthMethod, AuthMethodStatus
...
def test_render_text_no_resolved_chain_shows_warning():
    ...
    assert "aegiscore onboard" in output
