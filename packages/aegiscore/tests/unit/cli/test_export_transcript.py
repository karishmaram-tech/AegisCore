"""Tests for ``aegiscore-cli export-transcript``."""

from __future__ import annotations

from pathlib import Path

from aegiscore.cli.__main__ import main as cli_main
from aegiscore.cli.export_transcript import EXIT_NOT_FOUND, EXIT_OK
from aegiscore.cli.export_transcript import main as export_main
