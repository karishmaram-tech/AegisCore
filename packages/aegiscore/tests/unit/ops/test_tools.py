...
from aegiscore.tools.ops import (
    OPS_TOOLS,
...
from aegiscore.tools.ops.client import OpsControlError, OpsControlUnreachableError
...
def patch_client(monkeypatch):
    ...
    monkeypatch.setattr("aegiscore.tools.ops.tools.OpsControlClient", factory)
    return fake
...
def test_ops_start_unreachable_diagnostic(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "aegiscore.tools.ops.tools.OpsControlClient",
        lambda *_a, **_k: type(
            "X",
            (),
            {
