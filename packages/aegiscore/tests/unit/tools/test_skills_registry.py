"""Tests for ``aegiscore.tools.skills_registry`` — slug resolver + safety."""
...
def small_registry() -> list[SkillRecord]:
    return [
        ...
        _make_record(
            "/skills/standard/aegiscore/reporting/SKILL.md",
            description="Aegiscore reporting guide.",
        ),
    ]
...
class TestResolveSkill:
    ...
    def test_ambiguous_slug_returns_disambiguation(self, small_registry: list[SkillRecord]) -> None:
        ...
        assert "/skills/standard/aegiscore/reporting/SKILL.md" in ids
