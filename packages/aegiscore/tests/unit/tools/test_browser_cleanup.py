"""Tests for bounded, logged cleanup in ``aegiscore.tools.browser.tools``."""
...
from aegiscore.tools.browser.tools import (
    BrowserSessionManager,
    _reset_session_manager_for_tests,
    _safe_close,
)

_LOGGER_NAME = "aegiscore.tools.browser.tools"
...
async def test_close_continues_when_page_close_raises(
    ...
    from aegiscore.tools.browser.tools import _Tab
