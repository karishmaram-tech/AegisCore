"""Extended tests for aegiscore.tools.defense — push functions, edge cases.
...
from aegiscore.tools.defense import conops as conops_mod
from aegiscore.tools.defense.edr import (
    _CROWDSTRIKE_TYPE_MAP,
    _extract_yara_metadata,
    push_crowdstrike_ioa,
    push_defender_xdr_detection,
)
from aegiscore.tools.defense.elastic import (
    SigmaToElasticError,
...
from aegiscore.tools.defense.sentinel import (
    SigmaToKqlError,
    _field_clause_kql,
    _selection_to_kql,
...
from aegiscore.tools.defense.splunk import (
...
class TestSentinelConverter:
    ...
    def test_severity_map_critical_maps_to_high(self):
        from aegiscore.tools.defense.sentinel import _SEVERITY_MAP
...
class TestElasticConverter:
    ...
    def test_severity_map_informational_is_low(self):
        from aegiscore.tools.defense.elastic import _SEVERITY_MAP
