"""Unit tests for aegiscore.llm.router — thin wrapper over LLMModelMapping."""
...
class TestModelRouter:
    ...
    def test_resolve_with_fallback_high_tier_full_chain(self):
        chain = self.router.resolve_with_fallback("aegiscore")
        assert chain == [
    ...
    def test_resolve_with_single_credential_no_fallback(self):
        ...
        chain = router.resolve_with_fallback("aegiscore")
