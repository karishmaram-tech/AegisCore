"""Unit tests for aegiscore.llm.factory."""
...
from aegiscore.llm.factory import (
    LLMFactory,
    _is_real_key,
...
class TestLLMFactory:
    ...
    def test_get_model_different_roles_different_models(self):
        ...
        aegiscore = self.factory.get_model("aegiscore")
        assert recon is not aegiscore
        assert recon.model_name != aegiscore.model_name
    ...
    def test_get_fallback_models_high_tier_includes_all_methods(self):
        models = self.factory.get_fallback_models("aegiscore")
        names = [m.model_name for m in models]
        assert names == [
            "openai/gpt-5.5",
    ...
    def test_explicit_credentials_param(self):
        ...
        assert factory.get_model("aegiscore").model_name == "openai/gpt-5.5"
...
class TestResolveCredentials:
    ...
    def test_explicit_priority_no_creds_logs_error(self, monkeypatch, tmp_path, caplog):
        ...
        # ``aegiscore_core.utils.logging`` sets the parent aegiscore logger
...
class TestTemperatureDrop:
    ...
    def setup_method(self):
        from aegiscore.llm.factory import _model_drops_temperature
...
class TestActionableErrorTranslation:
    ...
    def setup_method(self):
        from aegiscore.llm.factory import _reraise_with_actionable_message
    ...
    def test_401_authentication_branch(self):
        ...
        assert "aegiscore onboard --reset" in msg
    ...
    def test_redact_secrets_preserves_nonsecret_text(self):
        from aegiscore.llm.factory import _redact_secrets
...
class TestDeepSeekReasoningContent:
    ...
    def test_create_chat_result_extracts_reasoning_content(self):
        ...
        from aegiscore.llm.factory import _DeepSeekThinkingChatOpenAI
    ...
    def test_model_detection(self):
        ...
        """
        from aegiscore.llm.factory import _model_is_deepseek_thinking
...
class TestLLMTimeout:
    ...
    def test_call_with_timeout_returns_successful_result(self) -> None:
        from aegiscore.llm.factory import call_with_timeout
    ...
    def test_ainvoke_resolves_timeout_before_creating_request_coroutine(
        ...
        from aegiscore.llm.factory import _ProxiedChatOpenAI
