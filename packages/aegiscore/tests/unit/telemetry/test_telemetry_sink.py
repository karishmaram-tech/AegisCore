"""Tests for aegiscore.telemetry.sink — consent-gated end-to-end behavior."""
...
from aegiscore.telemetry.config import TelemetryConfig, TelemetryMode
...
def test_session_id_stamped_on_every_event_type() -> None:
    ...
    sink.record_phase("recon", "pending", "aegiscore", session_id=sid)
    sink.close()
...
def test_session_id_for_is_stable_non_reversible_hash() -> None:
    from aegiscore.telemetry.sink import session_id_for
