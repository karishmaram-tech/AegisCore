"""Tests for aegiscore.telemetry.exporter — batching + offline tolerance."""
...
from aegiscore.telemetry import exporter as exporter_mod
from aegiscore.telemetry.exporter import BatchExporter
