"""Tests for aegiscore.agents.prompts.claude4_compat.

Loaded via importlib so the test suite does not require the full
aegiscore.agents runtime dependency tree (deepagents, langgraph, …).
...
class TestPrependNeutralPersona:
    def test_prepends_once(self) -> None:
        prompt = "AEGISCORE: autonomous red team orchestrator."
