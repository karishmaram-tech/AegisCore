...
from aegiscore.tools.references.catalog import REFERENCES, references_by_category
from aegiscore.tools.references.hydrate import HydrationResult
from aegiscore.tools.references.payloads import PayloadBundle
...
class TestH1SearchTitleSanitization:
    def test_control_char_in_title_stripped_in_envelope(
        ...
        from aegiscore.tools.references.h1_corpus import BugReport
