...
from aegiscore.sandbox_kernel import BackgroundJobTracker
...
def test_auto_background_path_registers_job():
    ...
    with (
        ...
        patch("aegiscore.sandbox_kernel.tmux.AUTO_BACKGROUND_SECONDS", 0.0),
        ...
        from aegiscore.sandbox_kernel import TmuxSessionManager
