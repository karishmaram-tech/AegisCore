"""Tests for ``aegiscore.agents.task_spec`` — scoped sub-agent handoff."""
...
from aegiscore.agents.task_spec import (
...
def test_render_includes_objective_engagement_dispatcher() -> None:
    ...
    assert "**Dispatched by:** aegiscore" in body
