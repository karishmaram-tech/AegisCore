"""Unit tests for the fetch chain — grid logic + the Aegiscore RoE per-hop
scope gate.
...
from aegiscore.sandbox_web import fetch_chain
from aegiscore.sandbox_web.fetch_chain import fetch
from aegiscore.sandbox_web.validators import SMALL_BODY_THRESHOLD, Verdict
