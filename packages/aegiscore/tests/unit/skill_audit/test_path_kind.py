...
def test_handles_relative_paths() -> None:
    ...
    assert (
        is_offensive_path("packages/aegiscore/aegiscore/skills/standard/recon/x/SKILL.md") is True
    )
    assert (
        is_offensive_path("packages/aegiscore/aegiscore/skills/standard/reporting/x/SKILL.md")
        is False
    )
