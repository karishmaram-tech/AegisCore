...
``packages/aegiscore/src/aegiscore/{core/schemas,llm/models,...}.py``
use ``__getattr__`` to delegate to the canonical
``aegiscore_core.*`` modules. Identity is a structural property of
...
def test_schemas_identity_preservation() -> None:
    ...
    with warnings.catch_warnings():
        ...
        from aegiscore.core.schemas import RoE as RoE_legacy
        from aegiscore_core.types.engagement import RoE as RoE_canonical
...
def test_llm_models_identity_preservation() -> None:
    with warnings.catch_warnings():
        warnings.simplefilter("ignore", DeprecationWarning)
        from aegiscore.llm.models import ModelProfile as MP_legacy
        from aegiscore_core.types.llm import ModelProfile as MP_canonical
...
def test_plugin_loader_identity_preservation() -> None:
    with warnings.catch_warnings():
        warnings.simplefilter("ignore", DeprecationWarning)
        from aegiscore.plugin_loader import PluginBundle as PB_legacy
        from aegiscore_core.plugin_loader import PluginBundle as PB_canonical
...
def test_research_graph_identity_preservation() -> None:
    with warnings.catch_warnings():
        warnings.simplefilter("ignore", DeprecationWarning)
        from aegiscore.tools.research.graph import Node as N_legacy
        from aegiscore_core.types.kg import Node as N_canonical
...
def test_dunder_lookup_does_not_warn() -> None:
    ...
    with warnings.catch_warnings(record=True) as ws:
        ...
        import aegiscore.core.schemas as _shim
...
def test_explicit_warning_on_legacy_attribute() -> None:
    ...
    import aegiscore.core.schemas as schemas_shim
