...
Closes spec §14 acceptance #8: each ``packages/aegiscore-sdk/examples/*``
...
KIND_TO_ENTRY_POINT_GROUP = {
    "tool": "aegiscore.tools",
    "middleware": "aegiscore.middleware",
    "agent": "aegiscore.agents",
    "callback": "aegiscore.callbacks",
    "skill": "aegiscore.skills",
    "prompt": "aegiscore.prompts",
}
...
def test_example_layout(kind: str) -> None:
    ...
    module_name = f"aegiscore_example_{kind}"
...
def test_example_declares_correct_entry_point_group(kind: str) -> None:
    ...
    # Module name matches kind: aegiscore-example-tool -> aegiscore_example_tool
    expected_module = f"aegiscore_example_{kind}"
