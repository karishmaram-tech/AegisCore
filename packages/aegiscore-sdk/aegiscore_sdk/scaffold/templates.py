"""Inline templates for the ``aegiscore-sdk plugin new`` scaffolder.
...
_TOOL_BODY = '''"""Custom tool contributed to Aegiscore."""
...
_MIDDLEWARE_BODY = '''"""Custom middleware contributed to Aegiscore."""
...
_AGENT_BODY = '''"""Custom agent contributed to Aegiscore."""
...
def get_agent() -> object:
    ...
    ``aegiscore.agents.standard.recon.create_recon_agent`` for an
...
_CALLBACK_BODY = '''"""Custom callback handler contributed to Aegiscore."""
...
A Aegiscore plugin ({kind}) scaffolded by ``aegiscore-sdk plugin new``.
...
name = "{plugin_name}"
version = "0.0.1"
description = "Aegiscore plugin scaffolded by aegiscore-sdk."
readme = "README.md"
